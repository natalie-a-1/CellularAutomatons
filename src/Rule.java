/**
 * The Rule class is an abstract class designed to create new Rule objects 
 * and use the rule to evolve generations and neighborhoods. 
 * 
 * 
 * @author Natalie hill
 *
 ...
 */
	...
	/**
	 * Displays all of the rules and their outputs with the ability to change the false
	 *  and true statements. 
	 * 
	 ...
	 * @param radius	specifies how far to go from index to get other states in generation
